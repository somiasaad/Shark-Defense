...
//   return (
//     <section className=" w-[100%] justify-between" style={{
//       display: "flex",
//       position: "relative",
//       backgroundColor: "#fff"
//     }}>
...
//             <span style={{ color: "#fff", marginLeft: " -33px" }} ><FaUser /></span>
...
//       <div className="user-data w-[85%] m-auto h-[100%] p-2 m-auto flex flex-col justify-center items-center" style={{ backgroundColor: "#fff" }}>
//         <div className="header w-[200px] h-[200px] p-2 flex flex-col items-center justify-center">
//           <img className="h-[80px] w-[80px] rounded-full object-cover  shadow-md shadow-blue-400" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1WrlOFC9t-IB34aiyMx5-Q8b4oST0_U0iZ1QJLq1mzw&s"} alt="" />
//           <div className="flex flex-col items-center justify-center gap-1 mt-2">
//             <h3 className="text-base w-full font-bold leading-7 text-[30px] tracking-tight text-blue-500">{user?.email}</h3>
//             <p className="text-sm  leading-6  rounded-full text-gray-500 text-[17px]">{user?.email}</p>
//           </div>
//         </div>
...
//               <input type="file" id="File" aria-label="Upload file " className="hidden" />
...
//             <input type="text" aria-label="Name" placeholder="Fullname" className="w-[90%]  md:w-[45%] p-1 rounded-md ring-1 ring-blue-400" />
//             <input type="email" aria-label="Name" placeholder="EmailAdress" className="w-[90%] md:w-[45%]  p-1 rounded-md ring-1 ring-blue-400" />
//             <div className="w-[100%] ">
...
//               <FaXTwitter size={26} />
//               <input type="text" aria-label="Name" placeholder="Twitter Link" className="w-[100%] md:w-[90%] p-1 rounded-md ring-1 ring-blue-400" />
//             </span>
...
//             <span className="w-[100%] md:w-[45%] flex items-center gap-2">
//               <FaInstagram size={26} />
//               <input type="text" aria-label="Name" placeholder="Instagram Link" className="w-[100%] md:w-[90%] p-1 rounded-md ring-1 ring-blue-400" />
//             </span>


//             <span className="w-[100%] md:w-[45%] flex items-center gap-2">
//               <IoEarth size={26} color="#EA4C89" />
//               <input type="text" aria-label="Name" placeholder="Personal Website" className="w-[100%] md:w-[90%] p-1 rounded-md ring-1 ring-blue-400" />
//             </span>

//             <span className="w-[100%] md:w-[45%] flex items-center gap-2">
//               <FaFacebookF size={26} color="#1877F2" />
//               <input type="text" aria-label="Name" placeholder="FaceBook Link" className="w-[100%] md:w-[90%] p-1 rounded-md ring-1 ring-blue-400" />
//             </span>
